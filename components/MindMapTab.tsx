          ...
          <div id="mindmap-result" className="animate-fade-in flex flex-col items-center space-y-16">
             ...
             <div className="w-full max-w-5xl pt-20 border-t-8 border-dashed border-indigo-100 flex flex-col items-center gap-12">
                <div className="text-center space-y-6 w-full max-w-2xl">
                   ...
                   <h3 className="text-4xl md:text-5xl font-black text-brand-800 font-display tracking-tight">🎤 LUYỆN THUYẾT TRÌNH</h3>
                   <p className="text-xl text-slate-500 font-bold italic">"Pallas AI sẽ soạn bài mẫu và chấm điểm bài nói của con!"</p>
                   <input 
                     type="text" 
